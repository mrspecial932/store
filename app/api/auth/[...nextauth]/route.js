...
const DEFAULT_PROFILE_IMAGE= "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-973460_1280.png"
...
export const authOptions = {
            ...
            async authorize(credentials){
                ...
                try {
                    ...
                    if(isRegistering){
                        ...
                        const passwordMatch = await bcrypts.compare(password , user.password);
    ...
    async session({session, token}){
        ...
        session.notificationPreferences = token.notificationPreferences;
