      ...
      >
        <div className="flex justify-between  w-full h-full">
          <div className=" w-full h-full flex flex-col justify-between">
            ...
            <div className=" dots bg-gray-100/60 backdrop-blur  ">
              <ul>
                {[
                  "Rolex",
                  "Patek Philipe",
            ...
            <div>
              <div className="bg-gray-400 h-[2px] w-full"></div>
              <div className=" bg-gray-50/60 backdrop-blur  h-30 w-full flex flex-col text-center justify-center items-center">
