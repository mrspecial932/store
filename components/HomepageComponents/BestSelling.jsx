...
const BestSellingWatches = () => {
 ...
 const nextWatch = ()=>setCurrentIndex((prevIndex)=> (prevIndex+1) % watches.length);
 const prevWatch = ()=>setCurrentIndex((prevIndex)=>(prevIndex -1 + watches.length))
 const getWatchIndex =(offset)=>(currentIndex + offset + watches.length) % watches.length ;
